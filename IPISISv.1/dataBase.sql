...
CREATE TABLE `bitacora` (
    ...
    `contenido_reunion` text DEFAULT NULL,
    `compromisos` text DEFAULT NULL,
    `dificultades` text DEFAULT NULL,
    `proyecto_id` int DEFAULT NULL,
     PRIMARY KEY (`id`),
     KEY `proyecto_id` (`proyecto_id`),
     CONSTRAINT `bitacora_pk` FOREIGN KEY (`proyecto_id`) REFERENCES `proyecto` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
);

-- Table: bitacora_adj_proyecto
DROP TABLE IF EXISTS `bitacora_adj_proyecto`;
CREATE TABLE `bitacora_adj_proyecto` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `nombre` varchar(128) DEFAULT NULL,
    `uri` varchar(256) DEFAULT NULL,
    `bitacora_id` int DEFAULT NULL,
     PRIMARY KEY (`id`),
     KEY (`bitacora_id`),
     CONSTRAINT `bitacora_adj_proyecto_pk`  FOREIGN KEY (`bitacora_id`) REFERENCES `bitacora` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
);
...
DROP TABLE IF EXISTS `profesor_rol_calificacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `profesor_rol_calificacion` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `rol_profesor` varchar(15) DEFAULT NULL,
  `profesor_id` int(11) DEFAULT NULL,
  `proyecto_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `profesor_id` (`profesor_id`),
  KEY `proyecto_id` (`proyecto_id`),
  CONSTRAINT `profesor_rol_calificacion_ibfk_1` FOREIGN KEY (`profesor_id`) REFERENCES `profesor` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `profesor_rol_calificacion_ibfk_2` FOREIGN KEY (`proyecto_id`) REFERENCES `proyecto` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `calificacion` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nota` double(1,1) DEFAULT NULL,
  `proyecto_compromiso_id` int(11) DEFAULT NULL,
  `profesor_rol_calificacion_id` int(11) DEFAULT NULL,
  `estudiante_id` int(11) DEFAULT NULL,
  `seccion_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `calificacion_pCompromisoId_pRolCalId_seccionId_unique` (`proyecto_compromiso_id`,`profesor_rol_calificacion_id`,`seccion_id`),
  KEY `proyecto_compromiso_id` (`proyecto_compromiso_id`),
  KEY `profesor_rol_calificacion_id` (`profesor_rol_calificacion_id`),
  KEY `seccion_id` (`seccion_id`),
  KEY `estudiante_id` (`estudiante_id`),
  CONSTRAINT `calificacion_ibfk_1` FOREIGN KEY (`proyecto_compromiso_id`) REFERENCES `proyecto_compromiso` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `calificacion_ibfk_2` FOREIGN KEY (`profesor_rol_calificacion_id`) REFERENCES `profesor_rol_calificacion` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `calificacion_ibfk_3` FOREIGN KEY (`seccion_id`) REFERENCES `seccion` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `calificacion_ibfk_4` FOREIGN KEY (`estudiante_id`) REFERENCES `estudiante` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
